...
export default class Details extends Component {
    ...
    componentDidMount() {
        this.setState({ params: this.props.match.params.id });
                                                        ...
                                                        <div class="col-xl-3 col-lg-4 col-md-6">
                                                            <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                                                <div class="gen-movie-contain">
                                                                    ...
                                                                    <div class="gen-info-contain">
                                                                        <div class="gen-movie-info">
                                                                            <h3><a href="movies-home.html">{movies.title}</a></h3>
                                                                        </div>
                                                                        <div class="gen-movie-meta-holder">
                                                                            <ul>
                                                                                <li>1hr 24mins</li>
                                                            ...
                                                            <div class="gen-load-more-button">
                                                                <div class="gen-btn-container">
                                                                    <a class="gen-button gen-button-loadmore" href="#">
                                                                        ...
                                                                        <span class="loadmore-icon" data-style="display: none;"><i
    ...
    getMovieDetails(id) {
        let pathUrl = config.apiUrl + `/GetMovieById/${id}`;
